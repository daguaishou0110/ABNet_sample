...
#        print("edge_embbing.shape:",edge_embbing.shape)
        ...
        feature=0.2*generality_feature+0.8*target_feature
...
outputpath = './output_AE_w_o_h/'
dataset = 'reddit'
if not os.path.exists(outputpath):
    os.mkdir(outputpath)
outfile = open('./output_AE_w_o_h/out_'+dataset+'_'+''+'.txt', 'w', encoding='utf-8')
...
dataname=dataset
train_data = f'w_o_h/'+dataname+'train.txt'
valid_data = f'w_o_h/'+dataname+'valid.txt'
test_data=f'w_o_h/'+dataname+'test.txt'
