...
from ganer_w import Autoencoder
        ...
        for i in range(self.num_time_steps):
            ...
            if i < 1:
                ...
                for j in np.arange(g_list[i - 1].number_of_nodes()):
                    ...
                    diff[j] = features[i - 1][j]-features[i][j]
    ...
    for time_id in time_ids:
        ...
        if time_id != time_ids[-1]:
            ...
            if original_ano_features_lists[time_id].size==0:
                ...
                generated_features_lists[time_id] = autoencoder.generate_abnormal_features(num_samples_lists[time_id])
...
with open('w_o_orthogonal_'+dataname + 'train.txt', 'w') as f:
