...
#        print("edge_embbing.shape:",edge_embbing.shape)
        ...
        feature=0.5*generality_feature+0.5*target_feature
...
def train_Adversarial_Model(dataset, train_loader, valid_loader, model, criterion,initial_learning_rate):
    model_path = 'output_AE_change_networksnap/' + dataset + '_model/'
...
outputpath = './output_AE_change_networksnap/'
dataset = 'mooc'
if not os.path.exists(outputpath):
    os.mkdir(outputpath)
outfile = open('./output_AE_change_networksnap/out_'+dataset+'_'+''+'.txt', 'w', encoding='utf-8')
...
dataname=dataset
train_data = f'data_AE_change_networkshot/'+str(network_number)+dataname+'train.txt'
valid_data = f'data_AE_change_networkshot/'+str(network_number)+dataname+'valid.txt'
test_data=f'data_AE_change_networkshot/'+str(network_number)+dataname+'test.txt'
...
for repeat in range(repeats):
    ...
    model_directory = 'output_AE_change_networksnap/'+dataset+'_model'
